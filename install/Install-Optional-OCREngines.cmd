...
title Audion Office OCR AI - Install Optional OCR Engines
...
"%PS_EXE%" -NoProfile -ExecutionPolicy Bypass -File "%SCRIPT_DIR%\Install-Optional-OCREngines.ps1" %PS_ARGS%
set "RC=%errorlevel%"
